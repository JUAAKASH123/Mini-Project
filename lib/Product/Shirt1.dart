...
class _ShirtPageState extends State<ShirtPage> {
  ...
  final String _productName = 'Stylish Shirt';
  final String _price = '₹999.99'; // Rupee symbol used here
  final String _imageUrl =
      'assets/Images/shirtpng.png'; // Update with your image path
  final String _description =
      'This stylish shirt is made of 100% cotton and provides all-day comfort. Perfect for formal occasions or casual outings.';
